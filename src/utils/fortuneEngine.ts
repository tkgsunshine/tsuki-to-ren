...
const mbtiTimingSubtitles: Record<string, { t85: string; t73: string; t60: string; t45: string; tLow: string }> = {
  'INTJ': {
    t85: '思考が落ち着く深夜の要点提案',
    t73: '雑音のない夕食後の1対1対話',
    t60: '用件を1点に絞った昼のミニマム連絡',
    t45: '返信不要を添えた朝の3行以内メッセージ',
    tLow: '思考の聖域を守る完全サイレント戦略'
  },
  'INTP': {
    t85: '知的好奇心を刺激する深夜の考察タイム',
    t73: '探求熱が高まる夕暮れ後の対等な議論',
    t60: '興味あるネタを軽く投げる昼のシェア',
    t45: '形式張らない朝のフランクな一言',
    tLow: '頭の充電を邪魔しないサイレント見守り'
  },
  'ENTJ': {
    t85: '将来の合意を取り付ける夜の重要アプローチ',
    t73: '仕事終わりのエネルギッシュな意見交換',
    t60: '意思決定をスムーズにする昼の要件確認',
    t45: '今日一日のタスクを応援する朝の短文連絡',
    tLow: '相手の優先順位を尊重する戦略的冷却'
  },
  'ENTP': {
    t85: 'アイデアと情熱が爆発する深夜のブレスト',
    t73: '突発的な盛り上がりを狙う夕食後の雑談',
    t60: '午後の活力を生むテンポの良い昼チャット',
    t45: 'クスッと笑えるネタを届ける朝の爽快一言',
    tLow: '好奇心を引き戻すあえての未読焦らし'
  },
  'INFJ': {
    t85: '心の鎧が解け本音が通い合う夜の共鳴時間',
    t73: '一日の感情を癒やし合う夕暮れのリラックス',
    t60: '心に温かな余白を届ける昼の優しい労い',
    t45: 'プレッシャーを与えない朝の爽やかメッセージ',
    tLow: '繊細な心を優しく守る静かな見守り'
  },
  'INFP': {
    t85: '二人の世界に浸れる深夜のロマンティック時間',
    t73: '素直な感情が最も響く夕食後のリラックス',
    t60: 'お互いの感性を共有する昼の穏やかな一言',
    t45: '負担をかけない朝の優しい応援メッセージ',
    tLow: '一人の内省時間を尊重するサイレントケア'
  },
  'ENFJ': {
    t85: '信頼と愛情をストレートに確かめ合える夜',
    t73: '今日一日の出来事を労い合う夕暮れ対話',
    t60: '相手への感謝と元気を届ける昼休みLINE',
    t45: '一日をポジティブにする朝の温かな声かけ',
    tLow: '相手の心の余裕を待つ充電インターバル'
  },
  'ENFP': {
    t85: '感情とワクワク感が最高潮に達する夜チャット',
    t73: '楽しい体験をリアルタイムで分かち合う夕食後',
    t60: '午後のテンションを高める楽しい昼休みネタ',
    t45: '元気を届ける朝のポジティブスタンプ一言',
    tLow: '相手からの自発的連絡を促す充電静観'
  },
  'ISTJ': {
    t85: '確かな信頼と誠実さを育む夜の定例連絡',
    t73: '翌日の予定を安心して共有できる夕暮れ時',
    t60: '日課を邪魔しない定例の昼休み確認',
    t45: '礼儀正しく誠実さを届ける朝の短文挨拶',
    tLow: '相手の生活リズムを最優先する慎重静観'
  },
  'ISFJ': {
    t85: 'お互いの優しさに心が満たされる夜の安らぎ',
    t73: '日頃の感謝を穏やかに伝えられる夕食後',
    t60: 'ほっと一息つける昼休みの思いやりメッセージ',
    t45: '「無理しないでね」を添えた朝の労い挨拶',
    tLow: '気疲れを癒やすための静かな休息見守り'
  },
  'ESTJ': {
    t85: '具体的な日程調整が最速で決まる夜の時間',
    t73: 'お互いの成果を讃え合える夕食後の会話',
    t60: '午後をスマートに進める昼の要件整理',
    t45: '一日のスタートを整える朝のクリアな短文挨拶',
    tLow: '多忙なスケジュールを考慮した計画的保留'
  },
  'ESFJ': {
    t85: '二人の距離がぐっと縮まる夜の親密対話',
    t73: '温かい気配りが心地よく響く夕食後の歓談',
    t60: '午後の安心感を届ける昼休みの優しい声かけ',
    t45: '一日を元気にスタートさせる朝の爽やかLINE',
    tLow: '周囲への気配り疲れを休ませる静観タイム'
  },
  'ISTP': {
    t85: '飾らない素の自分を見せ合える夜のリラックス',
    t73: '共通の趣味や画像で盛り上がる夕暮れ時',
    t60: '気負わずサクッと読める昼のワンタップ連絡',
    t45: '重さをゼロにした朝の超短文一言',
    tLow: '自由な作業時間を邪魔しない完全サイレント'
  },
  'ISFP': {
    t85: '心地よい空気感で素直になれる夜のひととき',
    t73: '美しい景色や好きな音楽をシェアする夕暮れ',
    t60: 'マイペースに返せる昼の軽やかなスタンプ',
    t45: 'テンポを縛らない朝の気軽なメッセージ',
    tLow: '自分の世界に浸る時間を尊重する放置戦略'
  },
  'ESTP': {
    t85: 'テンションとノリがMAXになる夜の勝負帯',
    t73: '次の楽しい予定をサクッと決める夕暮れ後',
    t60: 'クスッと笑える話題で楽しませる昼休み',
    t45: '元気にテンポよく送る朝の短文ファイト一言',
    tLow: 'あえて連絡を引いて希少価値を高める静観'
  },
  'ESFP': {
    t85: '楽しい話題で笑顔が止まらない深夜チャット',
    t73: '今日の面白かった出来事を話す夕食後タイム',
    t60: '午後の元気をチャージする昼のワクワク連絡',
    t45: '明るい笑顔を届ける朝のハッピースタンプ',
    tLow: '寂しさを引き出し自発的LINEを待つ冷却'
  }
};

const singleTimingSubtitles: Record<string, { t85: string; t73: string; t60: string; t45: string; tLow: string }> = {
  'INTJ': {
    t85: '長期ビジョンを設計する深夜の集中タイム',
    t73: '自己研鑽とスキルアップに最適な夕暮れ時',
    t60: '思考を整理し優先順位を決める昼休み',
    t45: '今日一日のタスクを冷静に組み立てる朝',
    tLow: '外部の雑音を遮断する完全デジタルデトックス'
  },
  'INTP': {
    t85: '知的好奇心を満たす深夜の読書・探求タイム',
    t73: '新しいアイデアや知識を吸収する夕暮れ時',
    t60: '気分転換に興味深い情報を眺める昼休み',
    t45: 'マイペースにエンジンをかける穏やかな朝',
    tLow: '誰にも邪魔されない自由な思考充電期'
  },
  'ENTJ': {
    t85: '目標達成と人生戦略を練り直す夜の勝負帯',
    t73: '一日の成果を確認し次へ繋げる夕食後',
    t60: '午後の実行計画をブラッシュアップする昼休み',
    t45: 'モチベーションを最高潮に高める朝のスタート',
    tLow: '冷静にリソースを再配分する戦略的休息'
  },
  'ENTP': {
    t85: 'ひらめきと発想が次々湧き出る深夜タイム',
    t73: '新しい体験やトレンドをリサーチする夕暮れ',
    t60: '午後の好奇心を刺激する楽しい昼休み',
    t45: 'ワクワクする予定を思い描く爽快な朝',
    tLow: 'インプットを休止し脳をリセットする充電期'
  },
  'INFJ': {
    t85: '魂の願いと直感が冴え渡る深夜の内省時間',
    t73: '心身のエネルギーを整える夕暮れのリラックス',
    t60: '静かな場所で心を癒やす昼休みの一息',
    t45: '一日を優しくスタートさせる朝の瞑想時間',
    tLow: '自己の内なる声に耳を傾ける完全静養期'
  },
  'INFP': {
    t85: '自分の世界観と創造力に浸る夜のゴールデンタイム',
    t73: 'お気に入りの音楽やアートに触れる夕暮れ',
    t60: '心地よい香りでリフレッシュする昼の休息',
    t45: '今日の小さな幸せを見つける優しい朝',
    tLow: '外の世界から一歩引いて心を守る充電期'
  },
  'ENFJ': {
    t85: '大切な人々への感謝と愛情が満ちる夜の時間',
    t73: '人とのつながりを温かく育む夕暮れ時',
    t60: '笑顔で午後を迎える昼休みのポジティブ充電',
    t45: '周囲に元気を届ける爽やかな朝のスタート',
    tLow: '他者への配慮を休み自分自身を甘やかす時間'
  },
  'ENFP': {
    t85: '夢とインスピレーションが広がる夜の冒険タイム',
    t73: '今日一日の楽しかった思い出を味わう夕暮れ',
    t60: '午後のテンションを高める楽しい昼休み',
    t45: '新しい一日に胸を躍らせるポジティブな朝',
    tLow: '立ち止まって自分のエネルギーを回復させる充電期'
  },
  'ISTJ': {
    t85: '着実な実績と将来基盤を固める夜の充実タイム',
    t73: '生活習慣や身の回りを整える夕食後',
    t60: '午後のタスクをスマートに整理する昼休み',
    t45: '規則正しいリズムで整える誠実な朝のスタート',
    tLow: '無理な予定を入れず体を休める計画的休養'
  },
  'ISFJ': {
    t85: '温かいお茶と安らぎで満たされる夜のセルフケア',
    t73: '今日頑張った自分を労わる夕食後のリラックス',
    t60: 'お気に入りのランチでほっと一息つく時間',
    t45: '一日の平穏を祈りながら整える静かな朝',
    tLow: '周りへの気遣いをお休みする自分ファースト期'
  },
  'ESTJ': {
    t85: '長期的なライフプランを整理する夜の達成時間',
    t73: '生活環境や持ち物のメンテナンスをする夕暮れ',
    t60: '午後の生産性を最大化する効率的な昼休み',
    t45: '一日をシャキッとスタートさせる朝のルーティン',
    tLow: 'スケジュールを白紙にして心身を休める時間'
  },
  'ESFJ': {
    t85: '大切な人たちとの絆を実感し心が温まる夜',
    t73: 'お気に入りの空間でくつろぐ夕食後の時間',
    t60: '優しい気持ちで午後を迎える昼のひととき',
    t45: '笑顔で周囲を照らす朝の爽やかなスタート',
    tLow: '人間関係のスイッチをオフにする完全リセット期'
  },
  'ISTP': {
    t85: '好きな作業や趣味に没頭できる深夜の職人タイム',
    t73: '身体を動かしたり道具を手入れする夕暮れ時',
    t60: 'サクッと気負わずリフレッシュする昼の休息',
    t45: '無駄な動きを省いてスッキリ目覚める朝',
    tLow: '誰にも干渉されない自分だけの完全自由時間'
  },
  'ISFP': {
    t85: '五感を研ぎ澄まし美しいものに触れる夜の贅沢',
    t73: '夕焼けや好きな風景を眺める夕暮れのリラックス',
    t60: '心地よい音楽を聴きながら過ごす昼の余白',
    t45: '自分のペースでゆったり始める心地よい朝',
    tLow: '自然体でダラダラ過ごして心を潤す充電期'
  },
  'ESTP': {
    t85: 'エネルギーと行動意欲がみなぎる夜のアクティブ帯',
    t73: '趣味やトレーニングで汗を流す夕暮れ時',
    t60: '美味しいものを食べてパワー全開にする昼休み',
    t45: 'スピード感を持って駆け抜ける朝のスタート',
    tLow: '過剰なアドレナリンを沈めるクールダウン期'
  },
  'ESFP': {
    t85: '大好きなエンタメや好きな世界を楽しむ夜時間',
    t73: '一日の楽しさを振り返り笑顔になる夕食後',
    t60: '午後へのワクワクをチャージする昼休み',
    t45: '明るい気分で一日を迎えるハッピーな朝',
    tLow: '好きなスイーツを食べて徹底的に甘やかす時間'
  }
};

export function getDailyContactAndAdvice(
  dailyScore: number,
  hasOpponent: boolean,
  character: 'tsuki' | 'ren',
  _myNick: string,
  ...
  oppMbti: string,
  myMbti: string,
  oppMbtiTrait: ReturnType<typeof getMbtiTraits> | null,
  myMbtiTrait: ReturnType<typeof getMbtiTraits>,
  oppStemTrait: ReturnType<typeof getStemTraits> | null
) {
  const oppNorm = (oppMbti || 'ENFP').toUpperCase();
  const myNorm = (myMbti || 'ENFP').toUpperCase();

  if (hasOpponent) {
    const subs = mbtiTimingSubtitles[oppNorm] || mbtiTimingSubtitles['ENFP'];
    let timeSlot = '';
    let subtitle = '';
    let advice = '';
    ...
    if (dailyScore >= 85) {
      ...
      if (character === 'tsuki') {
        ...
        advice = `本日はアプローチ成功確率がデータ上極大化（90%超）する最適勝負日です。${oppNick}様（${oppNorm}）の意思決定特性を踏まえ、${invite}と5W1Hで具体的な提案を行ってください。迷わず行動に移すことが関係の進展を確定させます。`;
      }
    } else if (dailyScore >= 73) {
      timeSlot = '19:30 〜 21:00';
      subtitle = subs.t73;
      const topic = oppMbtiTrait?.lineTopic || '「最近ハマっていることや好きなこと」';
      if (character === 'tsuki') {
        advice = `夕食後のリラックスタイムに、${topic}について優しく話を振ってみてください。${oppNorm}特有の関心と共鳴し、お相手から普段聞けない本音や嬉しい返信が返ってくる好調日です。`;
      } else {
        advice = `対話の合意形成率が高まる好調日です。夕食後の時間帯に${topic}を投げかけ、テンポ良くキャッチボールを展開してください。感情論を挟まずスマートに会話を広げることが親密性向上の最適解です。`;
      }
    } else if (dailyScore >= 60) {
      timeSlot = '12:30 〜 13:30';
      subtitle = subs.t60;
      const habit = oppMbtiTrait?.lineHabit || 'マイペースで丁寧なやり取りを好む傾向';
      if (character === 'tsuki') {
        advice = `無理に関係を急がせず、日々の小さな信頼を積み重ねる日です。${oppNick}様の返信ペース（${habit}）を温かく尊重しながら、お昼休みに日常のちょっとした写真や労いの言葉を届けてみてください。居心地の良さが深く心に残ります。`;
      } else {
        advice = `相性パラメータは安定巡航中です。相手のコミュニケーション特性（${habit}）に合わせ、お昼に要点を絞った短文で連絡を入れてください。低負荷なやり取りの継続が長期的信頼の土台となります。`;
      }
    } else if (dailyScore >= 45) {
      timeSlot = '7:30 〜 8:30';
      subtitle = subs.t45;
      const ng = oppMbtiTrait?.ngList[0] || '相手のペースを無視した連絡の連投';
      if (character === 'tsuki') {
        advice = `本日は運気の波が一時的な調整期に入っています。${oppNick}様の地雷である『${ng}』を厳重に避け、朝の時間帯に「今日もお互い無理せず頑張ろうね！」などの返信不要な爽やかな一言に留めるのがベストです。`;
      } else {
        advice = `摩擦リスクが検知される注意日です。${oppNick}様の防衛本能を刺激するNG行動『${ng}』を絶対に回避してください。連絡を入れる場合は朝の7:30〜8:30に要点のみの1行メッセージに限定し、即座にクローズするのが論理的リスクヘッジです。`;
      }
    } else {
      timeSlot = '終日静観推奨';
      subtitle = subs.tLow;
      const delayReason = oppMbtiTrait?.delayDeepReason || oppStemTrait?.delayReason || '一人でじっくり考えを整理したい充電フェーズにあるため';
      if (character === 'tsuki') {
        advice = `本日は星の巡りが相剋・休息フェーズです。${oppNick}様は現在『${delayReason}』という状態になりやすいため、あえて連絡を休んで自分磨きに集中しましょう。追わないあなたの凛とした余裕が、お相手の「どうしたのかな？」を引き出します。`;
      } else {
        advice = `本日の接触成功確率は極めて低調です。お相手は『${delayReason}』という心理的キャパシティ低下フェーズにあります。本日は一切の連絡を凍結し、相手の自発的アクションを待つ「サイレント静観戦略」が最も合理的な生存ルートです。`;
      }
    }

    return {
      bestContactHour: `${timeSlot}（${subtitle}）`,
      dailyActionAdvice: advice
    };
  } else {
    // シングルモード
    const subs = singleTimingSubtitles[myNorm] || singleTimingSubtitles['ENFP'];
    let timeSlot = '';
    let subtitle = '';
    let advice = '';
    ...
    if (dailyScore >= 85) {
      ...
      subtitle = subs.t85;
      if (character === 'tsuki') {
        advice = `あなたの持つ本来の魅力と愛のオーラが最高潮に達する日です。16タイプ（${myNorm}）の持ち味を活かし、お気に入りの服や心地よい場所へ出かけると、素晴らしい良縁や引き寄せが生まれます。`;
      } else {
        advice = `行動力と知性が冴え渡る最高水準の開運日です。明確な目標設定と自己投資を断行してください。あなたの強みである論理的プレゼンスが周囲を強く惹きつけます。`;
      }
    } else if (dailyScore >= 73) {
      timeSlot = '18:00 〜 20:00';
      subtitle = subs.t73;
      if (character === 'tsuki') {
        advice = `内面からのエネルギーが満ちています。興味のある分野のインプットや、会いたい人に軽い連絡を入れてみることで、今後の人間関係を好転させる素晴らしい種が蒔かれます。`
      } else {
        advice = `知的な刺激に恵まれ、効率的な前進が可能な好調日です。関心のあるコミュニティへの参加やスキルアップに時間を割くことで、将来の良縁へのレバレッジが働きます。`;
      }
    } else if (dailyScore >= 60) {
      timeSlot = '12:00 〜 14:00';
      subtitle = subs.t60;
      if (character === 'tsuki') {
        advice = `心が非常に安定している日です。16タイプ（${myNorm}）特有のマイペースを大切にし、美味しい食事や好きな音楽で自分自身を満たすことが、自然と人を惹きつけるオーラとなります。`;
      } else {
        advice = `現状維持とシステム調整に適した平穏日です。身の回りのデジタル環境やスケジュールの整理に集中することで、思考のノイズがクリアになり精神的余裕が生まれます。`;
      }
    } else if (dailyScore >= 45) {
      timeSlot = '21:30 〜 23:00';
      subtitle = subs.t45;
      const myNg = myMbtiTrait?.ngList[0] || '無理な自己犠牲や我慢';
      if (character === 'tsuki') {
        advice = `少し心身に疲れが出やすい調整日です。『${myNg}』に陥らないよう、暖かいお風呂に入って早めに休み、エネルギーを再充電しましょう。`;
      } else {
        advice = `エネルギー消費を抑えるべき慎重日です。無理なタスク追加や突発的な約束は避け、リソースを自己防衛と休息に集中配分するのが合理的です。`;
      }
    } else {
      timeSlot = '終日ゆっくり休息推奨';
      subtitle = subs.tLow;
      if (character === 'tsuki') {
        advice = `今日は徹底的に自分を慈しむ充電のスペシャルデーです。不要な外部情報を遮断し、自分をたっぷり甘やかして褒めてあげることで、明日以降の大開運ウェーブを迎え入れる心の余白が完成します。`;
      } else {
        advice = `リスク管理に徹するべき静観日です。外部との通信を最小限に抑え、睡眠と栄養補給に専念してください。冷却期間を設けることが、次なる戦略の成功確率を最大化させます。`;
      }
    }
...
export function generateFortuneResult(input: DiagnosisInput, character: 'ren' | 'tsuki'): FortuneResult {
  ...
  const dailyContactAdvice = getDailyContactAndAdvice(
    dailyScore,
    hasOpponent,
    character,
    myNickname,
