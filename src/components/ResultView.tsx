            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  justifyContent: 'center',
                  gap: '0.5rem',
                  cursor: isZoomedSaving ? 'not-allowed' : 'pointer'
                }}
              >
                <Download size={16} />
                <span style={{ color: avatarSavedSuccess ? '#4ade80' : 'inherit' }}>
                  {isZoomedSaving ? '画像を保存中...' : avatarSavedSuccess ? '✓ 保存しました' : '画像を保存する'}
                </span>
              </button>
            </div>
          </div>
