  ...
  const seoFaqs = [
    {
      ...
      a: '『月と蓮』は、東洋の最高峰占術である「四柱推命（命式・本質）」と「九星気学（運気バイオリズム）」、そして現代の心理統計学「16タイプ性格診断（コミュニケーションの癖）」を組み合わせたハイブリッド型恋愛相性診断です。全273,088,320通り（約2.7億通り）の算術マトリクスから、気になるお相手との相性スコアやLINE送信推奨時刻（吉時間）、お相手の取扱説明書（トリセツ）を即座に鑑定制成します。'
    },
    {
      q: '『月と蓮』の鑑定パターン数は何通りありますか？',
      a: '四柱推命（日柱3,600通り）× 九星気学（81通り）× 16タイプ（289通り）× 特殊星（9通り）× 関係性（20通り）× 守護AI（2通り）を完全掛け合わせした【全273,088,320通り（約2.7億通り）】の超精密算術マトリクスを搭載しています。'
    },
    {
      ...
      <div style={{ maxWidth: '640px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '2rem' }}>
        ...
        <div style={{
          ...
          <p style={{ fontSize: '0.71rem', color: '#cbd5e1', lineHeight: '1.6', margin: 0 }}>
            『月と蓮』の鑑定アルゴリズムは、伝統的な東洋占星術（萬年暦における蔵干・天干地支五行説）と、気学における九星周行モデル、および心理統計学（16要素行動特性マトリクス）の文献・データを精査し、全273,088,320通り（約2.7億通り）の算術プログラムによって高精度算出されています。
          </p>
        </div>
